	...
	<header class="page-header">
		<div class="wrapper">
			...
			<div class = "sub-header" style="float: right; padding-top:0">
				<p>Xin chào <span style="color: red">quản lý</span></p>
			...
			<div class="row">
				<div class="col-3">
					<form action="" method="post">
						<div id = "menu">
							<ul>
								<li><a href="NganhHoc.php" target="iframe">Tạo nghành học</a></li>
								<li><a href="LopHocTheoNganhHoc.php" target="iframe">Năm học - Lớp học phần</a></li>
								<li><a href="hocky-giaidoan.php" target="iframe"> Học kỳ - Giai đoạn</a></li>
							</ul>
						</div>
					</form>
				</div>
